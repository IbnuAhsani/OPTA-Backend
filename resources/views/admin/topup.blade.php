      ...
      <div class="mdl-grid demo-content">
        ...
        <div style="padding: 16px; overflow: auto" class="mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <table style="width: 70%; margin: auto" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp">
              <thead>
                <tr>
                  <th style="text-align: center;">Top Up ID</th>
              ...
              <tbody>
                ...
                <tr>
                  <td style="text-align: center;">{{ $top_up_request['id'] }}</td>
                  <td style="text-align: center;">{{ $top_up_request['user_id'] }}</td>
                  <td style="text-align: center;">{{ $top_up_request['unique_code'] }}</td>
                  <td style="text-align: center"><small>Rp</small>{{ number_format($top_up_request['nominal'], 2, ",", ".") }}</td>
